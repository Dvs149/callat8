...
class OrderController extends Controller
{
	...
	public function listOrder( Request $request ) {
	   ...
	   $doubleGoogleOrderData_active = DoubleGoogleOrderModel::with(['orderAddress'])->with(['doubleGoogleOrderItems'])->with(['driver'])->where('user_id',$user_id)->whereNotIn('order_status',['Completed']);
	   $doubleGoogleOrderData_completed = DoubleGoogleOrderModel::with(['orderAddress'])->with(['doubleGoogleOrderItems'])->with(['driver'])->where('user_id',$user_id)->where('order_status','Completed');
