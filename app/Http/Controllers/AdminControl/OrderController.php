...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = $this->_fetch_data->get_order_listing_data($request->keyword, $request->from_date, $request->to_date,  $request->status, $request->mobile);
    ...
    {
        $BreadCrumbPageHeader = $this->_breadCrumPageHeader->add_order();
        return view("admin.order.add-order", compact('BreadCrumbPageHeader'));
  ...
  "submit" => "Submit" */
    ...
    public function edit(Request $request, DoubleGoogleOrderModel $order)
    {
        ...
        $doubleGoogleOrderData = DoubleGoogleOrderModel::with(['customer'])->with(['orderAddress'])->with(['doubleGoogleOrderItems'])->with(['driver'])->with(['store'])->with('doubleGoogleOrderPhoto')->where('id', $order_id)->first()->toArray();
    ...
    public function status_change(Request $request)
    {
        ...
        $orderTrackingLog_body['driver_id'] = $orderlist->driver_id;
    ...
    {
            // $order = DoubleGoogleOrderModel::where('user_id',user-id);
            // $order->delete();
            // return "delete order id ".$id." done.";
            return "edit file please";
