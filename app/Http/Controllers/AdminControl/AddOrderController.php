...
class AddOrderController extends Controller
{
    ...
    public function addOrder(Request $request)
    {
        ...
        if($request->order_type == 'Pick up' ){
            ...
            $store_details_data = $this->GetApi(url('api/store_list_v2'));
            // dd($store_details_data['data']['store_list'][strtolower($request->order_type)]);
            if(isset($store_details_data['data']['store_list'][strtolower($request->order_type)])){
                $store_details = $store_details_data['data']['store_list'][strtolower($request->order_type)];
            } else {
                $store_details = '' ;
            }
            // dd($store_details);
