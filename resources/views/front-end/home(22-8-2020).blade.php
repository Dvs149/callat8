    	...
    	<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 wow fadeInRight">
					<h2>Be the first to try <strong>Double Google</strong></h2>
					<p>Doublegogle uses motorbikes and cars for instant door-to-door delivery service. The service is currently available for pick-up and destination islandwide.</p>
        	...
        	<div class="content">
            	<ul>
                	<li class="wow fadeInLeft">
						<div class="icon"><img src="images/whychoose_icon1.png" alt="" /></div>
					...
					<li class="wow fadeInLeft" data-wow-delay="0.5s">
						<div class="icon"><img src="images/whychoose_icon2.png" alt="" /></div>
    	...
    	<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 content_box wow fadeInLeft">
					<div class="icon"><img src="images/rate-img1.png" alt="" /></div>
					<h3>Doublegoogle - BIKE</h3>
					<ul>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 content_box wow fadeInRight">
					...
					<div class="icon"><img src="images/rate-img2.png" alt="" /></div>

					<h3>Doublegoogle - Car</h3>
        	...
        	<div class="content">
            	...
            	<ul>
                	...
                	<li>
						...
						<div class="works_image wow fadeInLeft"><img src="images/work-img1.jpg" alt="" /></div>
					...
					<li>
						...
						<div class="works_image wow fadeInRight"><img src="images/work-img2.jpg" alt="" /></div>
					...
					<li>
						...
						<div class="works_image wow fadeInLeft"><img src="images/work-img3.jpg" alt="" /></div>
					...
					<li>
						...
						<div class="works_image wow fadeInRight"><img src="images/work-img4.jpg" alt="" /></div>
...
<div class="col-xs-12 col-sm-12 col-md-12 ourpromise_sec">
	...
	<div class="row">
    	...
    	<div class="container">                	
			...
			<a href="#" class="button wow fadeInRight">SEND YOUR parcel</a>
