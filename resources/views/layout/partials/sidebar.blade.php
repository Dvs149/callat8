<div class="leftpanel">
    ...
    <div class="leftmenu">        
        <ul class="nav nav-tabs nav-stacked">
            ...
            <li class="{{ (request()->is('*/cms_pages')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('cms_pages'))}}"><span class="iconfa-tags"></span>CMS Pages</a></li>
            @endif
            <li class="{{ (request()->is('*/phones')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('phones'))}}"><span class="iconfa-tags"></span>View call for update</a></li>
            <li class="{{ (request()->is('*/testimonial')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('testimonial'))}}"><span class="iconfa-tags"></span>Testimonial Management</a></li>
            <li class="{{ (request()->is('*/review')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('review'))}}"><span class="iconfa-tags"></span>Review Management</a></li>
            {{-- <li  class="{{ (request()->is('*/cms')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('cms'))}}"><span class="iconfa-tags"></span> CMS Management</a></li> --}}
            {{-- <li class="{{ (request()->is('*/how_it_works')) || (request()->is('*/how_it_works/*/edit')) || (request()->is('*/how_it_works/create')) || (request()->is('*/terms_and_conditions')) || (request()->is('*/privacy_policy')) ? 'dropdown active' : 'dropdown' }}" ><a href=""><span class="iconfa-book"></span> CMS management</a> --}}
                
                {{-- <ul style="{{ (request()->is('*/how_it_works')) || (request()->is('*/how_it_works/*/edit')) || (request()->is('*/how_it_works/create')) || (request()->is('*/terms_and_conditions')) || (request()->is('*/privacy_policy')) ? 'display: block;' : 'display: none;' }}" > --}}
                    {{-- <li class="{{ (request()->is('*/how_it_works')) || (request()->is('*/how_it_works/create')) || (request()->is('*/how_it_works/*/edit')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('how_it_works'))}}">How It Works</a></li> --}}
                    {{-- <li class="{{ (request()->is('*/cms_pages')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('cms_pages'))}}">CMS Pages</a></li> --}}
                    {{-- <li class="{{ (request()->is('*/privacy_policy')) ? 'active' : '' }}"><a href="{{url(Helpers::admin_url('privacy_policy'))}}">Privacy Policy</a></li> --}}
                {{-- </ul> --}}
            {{-- </li> --}}
