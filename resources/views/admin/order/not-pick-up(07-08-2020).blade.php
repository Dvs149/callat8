<div class="span12">
    <h4 class="widgettitle">Order number #{{ $doubleGoogleOrderData['order_number'] }} <span class="pull-right">Order type: {{ ($doubleGoogleOrderData['order_type']=='Pick up' ? ucfirst($doubleGoogleOrderData['order_type']) : ucfirst($doubleGoogleOrderData['store']['type'] )) }}</span></h4>
