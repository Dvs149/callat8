     ...
     <div class="widgetbox">                        
      <div class="headtitle">
        ...
        <div class="widgetcontent" id="from">
            ...
            <div class="chatsearch">
              <input type="text" id="pickup_phone" pattern="[1-9]{1}[0-9]{9}" maxlength="10" name="pickup_phone" class="input-block-level  float" placeholder="Receiver Mobile" value="{{old('delivery[0][pickup_phone]')}}" />
            </div>
            ...
            <div class="chatsearch">
                ...
                <input type="text" id="pickup_address" name="pickup_address" class="input-block-level  float" placeholder="Address" value="{{old('delivery[0][pickup_address]')}}" />
            </div>
            <div class="row-fluid">
              <div class="par span6">
                <label>Date</label>
            ...
            <div class="chatsearch">
              <input type="number" id="parcel_value" name="parcel_value" class="input-block-level  float" placeholder="Parcel value" min="1" value="{{old('parcel_value') ? old('parcel_value') : 1}}" />
            </div>
        ...
        <div class="widgetcontent" id="from">
            <div id="reciever-detail-box">
              <div class="reciever-detail">
                  ...
                  <div class="chatsearch">
                    <input type="text" id="delivery_receiver_name" name="delivery[0][delivery_receiver_name]" class="input-block-level delivery_receiver_name float" placeholder="Sender Name" value="" />
                    </div>

                  <label class="control-label">Mobile:<span style="color:red;">*</span></label>
                  <div class="chatsearch">
                    <input type="text" id="delivery[0][delivery_phone]" pattern="[1-9]{1}[0-9]{9}" maxlength="10"  name="delivery[0][delivery_phone]" class="input-block-level delivery_phone float" placeholder="Receiver Mobile" value="" />
                  </div>
                  ...
                  <div class="chatsearch">
                     {{--  <select class="input-block-level" name="address_list_id">
                      ...
                      <input type="text" id="delivery_address" name="delivery[0][delivery_address]" class="input-block-level delivery_address float" placeholder="Address" value="" />
                  </div>
                  <div class="row-fluid">
                    <div class="par span6">
                      <label>Date</label>
      ...
      <div class="reciever-detail">
          ...
          <div class="row-fluid">
            ...
            <div class="par span6">
              <label>Time</label>
              <div class="input-append bootstrap-timepicker">
                  <input type="text" name="" class="input-small delivery_time timepicker" />
                  <span class="add-on"><i class="iconfa-time"></i></span>
              </div>
            </div>
          </div>
          ...
          <label class="control-label">Comments:</label>
          <div class="chatsearch">
            <input type="text" id="delivery_comment" name="" class="input-block-level delivery_comment float" placeholder="Comments" value="{{old('')}}" />
          </div>
        </div>
      </div>
