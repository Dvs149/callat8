        ...
        <div class="widgetcontent" id="from" >
           ...
           @if(ucfirst($order_type)!='Anything else')
             ...
             <div class="chatsearch">
              ...
              <label class="control-label">{{Str::ucfirst($order_type)=='Anything else' ? 'Pick-up Store' : Str::ucfirst($order_type) }} Name:<span style="color:red;">*</span></label>
              <div class="chatsearch">
              ...
              @endif
              <label class="control-label">{{Str::ucfirst($order_type)=='Anything else' ? 'Pick-up Store' : Str::ucfirst($order_type) }} Address:<span style="color:red;">*</span></label>
              <div class="chatsearch">
      ...
      <div class="headtitle">
        ...
        <div class="widgetcontent" id="from">
           ...
           <div class="chatsearch">
            ...
            <div class="chatsearch">
              <input type="text" id="delivery_phone" pattern="[1-9]{1}[0-9]{9}" maxlength="10" name="delivery[0][delivery_phone]" class="input-block-level  float" placeholder="Receiver Mobile" value="{{old('delivery[0][delivery_phone]')}}" />
            </div>
            ...
            <div class="chatsearch">
              <input type="text" id="delivery_comment" name="delivery[0][delivery_comment]" class="input-block-level  float" placeholder="Comments" value="{{old('delivery[0][delivery_comment]')}}" />
            </div>
        </div>
    </div>
            ...
            <div id="item-details">
              ...
              <div class="items-div">
                  <div class="chatsearch">
                    ...
                    <button class="btn btn-danger hidden remove-item" style="margin-top: -5px;padding: 5px 26px;" > Remove </button>
                  </div>
                </div>
              </div>
