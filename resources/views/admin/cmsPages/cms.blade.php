...
<script type="text/javascript">
    ...
    //on reset change value of update to submit
      ...
      $('#add_data').click(function(){
        window.location.href='{{url(Helpers::admin_url("cms_pages/create"))}}';
      })
     ...
     processing: false,
     serverSide: true,
     ajax: "{{url(Helpers::admin_url('cms_pages'))}}",
     //------------------------------------------------------
     "columnDefs": [
     /*  {
     ...
     columns: [
            ...
            // {data:'content_of_page', name:'content_of_page'},
